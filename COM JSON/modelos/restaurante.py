...
class Restaurante:
    ...
    def __init__(self, nome, categoria):
      self._nome = nome.title() # Nome do restaurante, formado com a primeira letra maiúscula
      self._categoria = categoria.upper() # Categoria do restaurante, formado com a primeira letra maiúscula
    ...
    def __str__(self):
        # Retorna uma apresentação textual do restaurante, mostrando nome e categoria
    ...
    def lista_restaurantes(cls):
       ...
       for restaurante in cls.restaurantes:
          print(f"{restaurante._nome.ljust(25)} | {restaurante._categoria.ljust(25)} | {str(restaurante.media_avaliações).ljust(25)} | {restaurante.ativo}")
...
def receber_avaliacao(self, cliente, nota):
   # A diciona uma nova avaliação ao restaurante, desde que a nota esteja entre 0 e 10
    if 0 <= nota <= 10:
